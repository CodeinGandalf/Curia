...
def main():
    ...
    # In der Funktion um die Odometry zu berechnen w und ticks zurückgeben
    # Im Funktionsaufruf diese beiden Variablen empfangen

    # Dann im main loop der encoder node diesen Teil einfuegen:
    ...
    joint_state.effort = [0.0, 0.0, 0.0, 0.0]  # optional
